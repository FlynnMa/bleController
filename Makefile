...
GCC_BIN = "c:/armgcc/bin/"
PROJECT = bleController
...
CC_SYMBOLS = -DTARGET_NRF51822 -DTARGET_M0 -DTARGET_CORTEX_M -DTARGET_NORDIC -DTARGET_NRF51822_MKIT -DTARGET_MCU_NRF51822 -DTARGET_MCU_NORDIC_16K -DTOOLCHAIN_GCC_ARM -DTOOLCHAIN_GCC -D__CORTEX_M0 -DARM_MATH_CM0 -DMBED_BUILD_TIMESTAMP=1438940633.38 -D__MBED__=1 -DNRF51
...
#================================================
OBJECTS += ./trace/trace.o
INCLUDE_PATHS += -I./trace

OBJECTS += ./records/records.o
INCLUDE_PATHS += -I./records

OBJECTS += protocal/protocal.o protocal/protocalApi.o protocal/bicProcess.o
